...
IF "%~1" == "" (
	SET /P PackageVersion="%ESC%[92mOpenSilver.Controls.ToolTips version:%ESC%[0m "
...
ECHO. 
%BUILD_DIR%\nuget.exe pack %BUILD_DIR%\nuspec\OpenSilver.Controls.ToolTips.nuspec -OutputDirectory "%BUILD_DIR%\output" -Properties "PackageVersion=%PackageVersion%;OpenSilverDependencyVersion=%OpenSilverPkgVersion%;Configuration=%CFG%"
